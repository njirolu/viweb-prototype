...
const outputFile = path.join(projectRoot, 'frontend', 'runner', 'src', 'generated-files.ts');
...
const directoriesToInclude = ['server', 'frontend/notes', 'frontend/shared'];
